...
const requiredCiFiles = [
  ...
  "docs/ci/gitlab-reference/README.md",
  "docs/ci/gitlab-reference/gitlab-ci.yml.example",
  "docs/ci/gitlab-reference/feishu-product-update-template.md",
  "docs/ci/gitlab-reference/baseline/package.json",
  "docs/ci/gitlab-reference/baseline/package-lock.json",
  "docs/ci/gitlab-reference/baseline/src/service-status.mjs",
  "docs/ci/gitlab-reference/baseline/test/service-status.test.mjs",
  "docs/ci/gitlab-reference/baseline/docs/product-behavior.md",
  "docs/ci/gitlab-reference/feature/src/service-status.mjs",
  "docs/ci/gitlab-reference/feature/test/service-status.test.mjs",
  "docs/ci/gitlab-reference/follow-up/docs/product-behavior.md",
